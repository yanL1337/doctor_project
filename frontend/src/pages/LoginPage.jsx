...
const LoginPage = ({ setID }) => {
  ...
  return (
    <div>
      <section className="h-fit flex flex-col md:flex-row justify-center space-y-10 md:space-y-0 md:space-x-16 items-center my-2 mx-5 md:mx-0 md:my-0">
        ...
        <div className="md:w-1/3 max-w-sm">
          ...
          <input
            ref={emailRef}
            className="text-sm w-full px-4 text-black bg-white py-2 border border-solid border-gray-300 rounded"
            type="text"
            placeholder="Email Address"
          />
          <input
            ref={passRef}
            className="text-sm w-full text-black px-4 py-2 bg-white border border-solid border-gray-300 rounded mt-4"
            type="password"
